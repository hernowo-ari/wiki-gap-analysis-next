...
// // Function to calculate Lorenz curve values
// const calculateLorenzCurve = (data) => {
//   const cumulativeWordCounts = data.reduce((acc, currentValue) => {
//     acc += currentValue;
//     return acc;
//   }, 0);

//   const lorenzCurveValues = data.map((value, index) => {
//     const cumulativePercentage = data.slice(0, index + 1).reduce((acc, currentValue) => acc + currentValue, 0) / cumulativeWordCounts;
//     return cumulativePercentage;
//   });

//   return lorenzCurveValues;
// };